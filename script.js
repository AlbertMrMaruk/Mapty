    ...
    let html = `
      ...
      day: '2-digit',
          ...
          <ul class="workout__icons">
            <li><img class="edit" src="/complete-javascript-course-master/15-Mapty/starter/pencil.png"></li>
            <li><img class="delete" src="/complete-javascript-course-master/15-Mapty/starter/x.png"></li>
          </ul>
